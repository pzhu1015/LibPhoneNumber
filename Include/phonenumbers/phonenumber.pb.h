...
class PhoneNumber final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_raw_input();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_preferred_domestic_carrier_code();
...
inline std::string* PhoneNumber::release_extension() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return extension_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline std::string* PhoneNumber::release_raw_input() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return raw_input_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline std::string* PhoneNumber::release_preferred_domestic_carrier_code() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  return preferred_domestic_carrier_code_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
